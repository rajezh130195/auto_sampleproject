...
exports.config = {
    ...
    //
    specs: ['./features/registerUser.feature'],
    stepDefinitions: ['./step-definitions/**/*.js'],
    // Patterns to exclude.
    exclude: [
    ...
    // Set maxInstances to 1 globally if you only want to run one session at a time
    maxInstances: 1,

    // Run tests on the local browser
    //runner: 'local',
